عالی. پس وضعیت رسمی الان:
      ...
      ✅ Phase 5 — API Contract Stabilization بسته شد
[x] Phase 5 / Step 7 — Closure Report
[x] tests green
[x] commit done
...
هدف این قدم حذف یا جابه‌جایی فوری فایل‌ها نیست. فقط می‌خواهیم یک برنامه رسمی و امن برای تمیز کردن repo بنویسیم، چون پروژه پر شده از:
...
این فایل را بساز:
      ...
      cat > docs/phase6_repository_hygiene_plan.md <<'MD'
# Phase 6 / Step 1 — Repository Hygiene Plan
...
اگر تست‌ها سبز بود:
      ...
      git status --short
git add docs/phase6_repository_hygiene_plan.md
git commit -m "docs: add phase 6 repository hygiene plan"
    
    
  
  

بعد از commit وضعیت می‌شود
      ...
      [x] Phase 6 / Step 1 — Repository Hygiene Plan
...
در Step 2 تازه با احتیاط وارد .gitignore، runtime root مثل var/، و مسیرهای خروجی/آپلود/پروژه می‌شویم.
